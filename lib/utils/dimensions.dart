...
class Dimensions {
  ...
  static double listviewtextboxSize = screenWidth / 3.92;

  //popular food

  static double popularFoodImgSize = screenWidth / 2.01;
}
